...
const HOCDocuments = () => {
    ...
    const fetchCases = async () => {
        try {
            ...
            const assignedCases = res.data.filter(caseItem =>
                caseItem.assignedTo &&
            ...
            <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-3">
                    <button
                        ...
                        disabled={uploading}
                        className="flex items-center gap-2 px-6 py-2.5 bg-purple-600 text-white font-semibold rounded-lg hover:bg-purple-700 transition-colors disabled:opacity-50"
                    >
            ...
            <div className="flex justify-between items-center bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                <div className="relative w-96">
                    ...
                    <input
                        ...
                        className="w-full text-black pl-10 pr-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
                        value={searchTerm}
                ...
                <div className="flex items-center gap-3">
                    <div className="flex items-center gap-2">
                        ...
                        <select
                            ...
                            className="px-3 py-2 text-black border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 text-sm"
                        >
                    ...
                    <div className="flex items-center gap-2 bg-gray-100 p-1 rounded-lg">
                        ...
                        <button
                            ...
                            className={`p-2 rounded-md transition-all ${viewMode === 'list' ? 'bg-white shadow-sm text-purple-600' : 'text-gray-500 hover:text-gray-700'}`}
                        >
                            <ListIcon size={20} />
                        </button>
                    </div>
                    ...
                    <div className="bg-white rounded-xl shadow-xl w-full max-w-md p-6 flex flex-col max-h-[90vh]">
                        ...
                        <div className="mb-4">
                            <input
                                ...
                                className="w-full text-black px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
                                value={shareSearch}
